# Get PostgreSQL on IBM Cloud

You should have an IBM Cloud account, otherwise you can [register here].
At the end of the tutorial you will have a cluster with PostgreSQL up and runnning.
...
* Give **tags** to your PostgreSQL, for more information visit [tags]
...
* Please set the PostgreSQL password in the parameters
![pass](/password.png)
...
* Your  PostgreSQL workspace has been successfully deployed

![PostgreSQL-finsihed](/done.png)
...
* Enter your pod with bash
 ...
 ```sh
$ kubectl exec --stdin --tty postgresqlad-5b26-4f-postgresql-0 -n NAMESPACE -- /bin/bash
```
![bash](/bash.png)

* After you are in your pod please enter your PostgreSQL, enter your password after the prompt
...
You have succesfully deployed PostgreSQL IBM Cloud! 
